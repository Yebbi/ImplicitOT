...
class MINIBOONE:
    ...
    def __init__(self, normalization_type):
        ...
        file = '/home/yesom/Codes/Implicit_OT/data/miniboone/data.npy'
        trn, val, tst = load_data_normalised(file, normalization_type)
...
def load_data_normalised(root_path, normalization_type):
